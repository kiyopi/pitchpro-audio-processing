...
var He = (l, e, t) => e in l ? $e(l, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[e] = t;
var R = (l, e, t) => He(l, typeof e != "symbol" ? e + "" : e, t);
const b = class b {
  /**
...
class Te {
  ...
  async _doInitialize() {
    try {
      ...
      throw E.logError(t, "AudioManager initialization"), this.lastError = t, this.isInitialized = !1, this._cleanup(), t;
    }
  }
  /**
  ...
  _createStructuredError(e, t) {
    ...
    ) : e.message.includes("AudioContext") || e.message.includes("audio") || e.message.includes("context") ? new G(
  ...
  for (s >>= 2; s >= 2; s >>= 2) {
    ...
    for (o = 0; o < t; o += n)
      for (var d = o + f, u = o, m = 0; u < d; u += 2, m += s) {
        const g = u, v = g + f, y = v + f, S = y + f, A = e[g], p = e[g + 1], w = e[v], N = e[v + 1], P = e[y], _ = e[y + 1], k = e[S], q = e[S + 1], O = A, $ = p, H = h[m], V = c * h[m + 1], B = w * H - N * V, L = w * V + N * H, C = h[2 * m], D = c * h[2 * m + 1], z = P * C - _ * D, Y = P * D + _ * C, Z = h[3 * m], ee = c * h[3 * m + 1], te = k * Z - q * ee, ie = k * ee + q * Z, se = O + z, Q = $ + Y, W = O - z, ne = $ - Y, oe = B + te, X = L + ie, J = c * (B - te), re = c * (L - ie), le = se + oe, me = Q + X, fe = se - oe, ge = Q - X, pe = W + re, ve = ne - J, ye = W - re, Se = ne + J;
        e[g] = le, e[g + 1] = me, e[v] = pe, e[v + 1] = ve, e[y] = fe, e[y + 1] = ge, e[S] = ye, e[S + 1] = Se;
      }
  }
};
...
I.prototype._singleTransform4 = function(e, t, i) {
  const s = this._out, n = this._data, o = this._inv ? -1 : 1, r = i * 2, a = i * 3, c = n[t], h = n[t + 1], f = n[t + i], d = n[t + i + 1], u = n[t + r], m = n[t + r + 1], g = n[t + a], v = n[t + a + 1], y = c + u, S = h + m, A = c - u, p = h - m, w = f + g, N = d + v, P = o * (f - g), _ = o * (d - v), k = y + w, q = S + N, O = A + _, $ = p - P, H = y - w, V = S - N, B = A - _, L = p + P;
  s[e] = k, s[e + 1] = q, s[e + 2] = O, s[e + 3] = $, s[e + 4] = H, s[e + 5] = V, s[e + 6] = B, s[e + 7] = L;
};
I.prototype._realTransform4 = function() {
  ...
  if (n === 4)
    for (o = 0, r = 0; o < t; o += n, r++) {
      const Ce = a[r];
      this._singleRealTransform2(o, Ce >>> 1, s >>> 1);
    }
  else
    for (o = 0, r = 0; o < t; o += n, r++) {
      const Ce = a[r];
      this._singleRealTransform4(o, Ce >>> 1, s >>> 1);
    }
  var c = this._inv ? -1 : 1, h = this.table;
  for (s >>= 2; s >= 2; s >>= 2) {
    n = t / s << 1;
    ...
    for (o = 0; o < t; o += n)
      for (var m = 0, g = 0; m <= u; m += 2, g += s) {
        var v = o + m, y = v + d, S = y + d, A = S + d, p = e[v], w = e[v + 1], N = e[y], P = e[y + 1], _ = e[S], k = e[S + 1], q = e[A], O = e[A + 1], $ = p, H = w, V = h[g], B = c * h[g + 1], L = N * V - P * B, C = N * B + P * V, D = h[2 * g], z = c * h[2 * g + 1], Y = _ * D - k * z, Z = _ * z + k * D, ee = h[3 * g], te = c * h[3 * g + 1], ie = q * ee - O * te, se = q * te + O * ee, Q = $ + Y, W = H + Z, ne = $ - Y, oe = H - Z, X = L + ie, J = C + se, re = c * (L - ie), le = c * (C - se), me = Q + X, fe = W + J, ge = ne + le, pe = oe - re;
        if (e[v] = me, e[v + 1] = fe, e[y] = ge, e[y + 1] = pe, m === 0) {
          var ve = Q - X, ye = W - J;
          e[S] = ve, e[S + 1] = ye;
          continue;
        }
        if (m !== u) {
          var Se = ne, De = -oe, xe = Q, Ie = -W, Ne = -c * le, Re = -c * re, Pe = -c * J, _e = -c * X, ze = Se + Ne, ke = De + Re, qe = xe + _e, Oe = Ie - Pe, be = o + d - m, Ae = o + f - m;
          e[be] = ze, e[be + 1] = ke, e[Ae] = qe, e[Ae + 1] = Oe;
        }
      }
  }
};
...
I.prototype._singleRealTransform4 = function(e, t, i) {
  const s = this._out, n = this._data, o = this._inv ? -1 : 1, r = i * 2, a = i * 3, c = n[t], h = n[t + i], f = n[t + r], d = n[t + a], u = c + f, m = c - f, g = h + d, v = o * (h - d), y = u + g, S = m, A = -v, p = u - g, w = m, N = v;
  s[e] = y, s[e + 1] = 0, s[e + 2] = S, s[e + 3] = A, s[e + 4] = p, s[e + 5] = 0, s[e + 6] = w, s[e + 7] = N;
};
...
class ae {
  ...
  constructor(e, t) {
    ...
    this._inputLength = e, this._fft = new Ue(We(2 * e)), this._bufferSupplier = t, this._paddedInputBuffer = this._bufferSupplier(this._fft.size), this._transformBuffer = this._bufferSupplier(2 * this._fft.size), this._inverseBuffer = this._bufferSupplier(2 * this._fft.size);
  }
  /**
...
let Qe = class he {
  ...
  constructor(e, t) {
    ...
    this._autocorrelator = new ae(e, t), this._nsdfBuffer = t(e);
  }
  /**
   ...
   */
  static forFloat32Array(e) {
    return new he(e, (t) => new Float32Array(t));
  }
  /**
   ...
   */
  static forFloat64Array(e) {
    return new he(e, (t) => new Float64Array(t));
  }
  /**
...
class Je {
  ...
  constructor(e, t = {}) {
    this.pitchDetector = null, this.analyser = null, this.rawAnalyser = null, this.animationFrame = null, this.componentState = "uninitialized", this.isInitialized = !1, this.isDetecting = !1, this.lastError = null, this.analyserIds = [], this.currentVolume = 0, this.rawVolume = 0, this.currentFrequency = 0, this.detectedNote = "--", this.detectedOctave = null, this.pitchClarity = 0, this.volumeHistory = [], this.stableVolume = 0, this.previousFrequency = 0, this.harmonicHistory = [], this.disableHarmonicCorrection = !1, this.callbacks = {}, this.deviceSpecs = null, this.silenceStartTime = null, this.silenceWarningTimer = null, this.silenceTimeoutTimer = null, this.isSilent = !1, this.hasWarned = !1, this.audioManager = e, this.config = {
      ...
      // 消音判定の音量閾値
      ...t.silenceDetection
    }, this.frameRateLimiter = new Xe(45);
  }
  /**
  ...
  async initialize() {
    ...
    try {
      ...
      this.rawAnalyser = this.audioManager.createAnalyser(r, {
        ...
        maxDecibels: -10,
        useFilters: !1
      }), this.analyserIds.push(r), console.log("✅ [PitchDetector] Analysers created:", this.analyserIds), this.pitchDetector = Qe.forFloat32Array(this.analyser.fftSize), typeof process < "u" && ((e = process.env) == null ? void 0 : e.NODE_ENV) === "development" && console.log(`[Debug] Pitchyインスタンス作成: ${!!this.pitchDetector}, FFTサイズ: ${this.analyser.fftSize}`), this.componentState = "ready", this.isInitialized = !0, (i = (t = this.callbacks).onStateChange) == null || i.call(t, this.componentState), console.log("✅ [PitchDetector] Initialization complete");
    } catch (o) {
      const r = o instanceof F ? o : new G(
  ...
  detectPitch() {
    ...
    if (this.analyser.getFloatTimeDomainData(i), this.rawAnalyser.getFloatTimeDomainData(s), typeof process < "u" && ((P = process.env) == null ? void 0 : P.NODE_ENV) === "development") {
      ...
      console.log(`[Debug] バッファー分析: 非ゼロ値=${C}/${t}, 最大値=${D.toFixed(6)}`);
    }
    let n = 0;
    for (let C = 0; C < t; C++)
      n += Math.abs(i[C]);
    ...
    try {
      ...
      if (console.warn("⚠️ [PitchDetector] Pitch detection error (recoverable):", D.toJSON()), Ee(D))
        m = 0, g = 0;
      else {
        (O = (q = this.callbacks).onError) == null || O.call(q, D);
        return;
      }
    }
...
class tt {
  ...
  createFilterChain() {
    ...
    try {
      ...
      throw E.logError(t, "NoiseFilter initialization"), console.error("❌ [NoiseFilter] Failed to create filter chain:", t.toJSON()), t;
    }
  }
  /**
...
var ue = /* @__PURE__ */ ((l) => (l[l.DEBUG = 0] = "DEBUG", l[l.INFO = 1] = "INFO", l[l.WARN = 2] = "WARN", l[l.ERROR = 3] = "ERROR", l[l.SILENT = 4] = "SILENT", l))(ue || {});
class ce {
  constructor(e = 1, t = "", i = {}) {
   ...
   */
  child(e, t = {}) {
    const i = this.prefix ? `${this.prefix}:${e}` : e, s = { ...this.context, ...t }, n = new ce(this.level, i, s);
   ...
   */
  logToConsole(e) {
    const t = new Date(e.timestamp).toISOString(), i = ue[e.level], s = e.prefix ? `[${e.prefix}]` : "", n = `${t} ${i} ${s} ${e.message}`, o = this.getConsoleMethod(e.level);
...
const de = new ce(1, "PitchPro"), it = (l, e) => de.debug(l, e), st = (l, e) => de.info(l, e), nt = (l, e) => de.warn(l, e), ot = (l, e, t) => de.error(l, e, t);
class Ke {
  constructor(e, t = {}) {
...
class Ze {
  ...
  constructor(e = {}) {
    ...
    this.currentState = "uninitialized", this.isPermissionGranted = !1, this.lastError = null, this.eventCallbacks = {}, this.deviceSpecs = null, this.config = {
      ...
      logging: {
        level: ((f = e.logging) == null ? void 0 : f.level) ?? ue.INFO,
    ...
    ), this.logger.debug("Initializing MicrophoneController", { config: this.config }), this.audioManager = new Te(this.config.audioManager), this.lifecycleManager = new Ke(this.audioManager, this.config.lifecycle), this.errorSystem = this.config.notifications.enabled ? new Ye() : null, this.setupEventHandlers(), this.detectDevice();
  }
  /**
  ...
  handleError(e, t) {
    ...
    E.logError(i, `MicrophoneController ${t}`), console.error(`❌ [MicrophoneController] Error in ${t}:`, i.toJSON()), this.lastError = e, this.updateState("error"), this.errorSystem && (t === "initialization" || t === "lifecycle" ? this.errorSystem.showMicrophoneError(e, t) : this.errorSystem.showError(
      "マイクエラー",
  ...
  _createStructuredError(e, t) {
    ...
    ) : e.message.includes("AudioContext") || e.message.includes("audio") || e.message.includes("context") || e.message.includes("initialization") ? new G(
      "オーディオシステムの初期化に失敗しました。デバイスの音響設定を確認するか、ブラウザを再起動してください。",
      {
        operation: t,
        originalError: e.message,
...
class rt {
  ...
  async initialize() {
    ...
    try {
      this.updateState("initializing"), this.debugLog("Starting initialization..."), this.micController = new Ze({
        audioManager: {
          sampleRate: 44100,
          echoCancellation: !1,
          autoGainControl: !1
      ...
      }), await this.micController.initialize(), this.pitchDetector = new Je(this.audioManager, {
      ...
      throw E.logError(t, "AudioDetectionComponent initialization"), this.lastError = t, this.updateState("error"), t;
    }
  }
  /**
  ...
  startDetection() {
    if (!this.isInitialized || !this.pitchDetector) {
      ...
      throw E.logError(e, "AudioDetection start"), this.handleError(e, "start_detection"), e;
    }
    try {
  ...
  updateUI(e) {
    ...
    try {
      if (this.uiElements.volumeBar) {
        const s = Math.min(100, e.volume * (((t = this.deviceSettings) == null ? void 0 : t.volumeMultiplier) ?? 1));
      ...
      if (this.uiElements.volumeText) {
        const s = Math.min(100, e.volume * (((i = this.deviceSettings) == null ? void 0 : i.volumeMultiplier) ?? 1));
        this.uiElements.volumeText.textContent = `${s.toFixed(1)}%`;
      }
      if (this.uiElements.frequency && (this.uiElements.frequency.textContent = x.formatFrequency(e.frequency)), this.uiElements.note) {
        const s = x.frequencyToNote(e.frequency);
   ...
   */
  updateSelectors(e) {
    this.debugLog("Updating selectors:", e), this.resetAllUIElements(), e.volumeBarSelector !== void 0 && (this.config.volumeBarSelector = e.volumeBarSelector), e.volumeTextSelector !== void 0 && (this.config.volumeTextSelector = e.volumeTextSelector), e.frequencySelector !== void 0 && (this.config.frequencySelector = e.frequencySelector), e.noteSelector !== void 0 && (this.config.noteSelector = e.noteSelector), this.cacheUIElements(), this.debugLog("Selectors updated, old elements reset, and UI elements re-cached:", Object.keys(this.uiElements));
  }
  /**
    ...
    try {
      [
        ...
        if (t) {
          ...
          i && (t.includes("volume-bar") ? i instanceof HTMLProgressElement ? i.value = 0 : i.style.width = "0%" : t.includes("volume-text") ? i.textContent = "0.0%" : t.includes("frequency") ? i.textContent = "0.0 Hz" : t.includes("note") && (i.textContent = "-"));
        }
  ...
  createStructuredError(e, t) {
    ...
    ) : e.message.includes("AudioContext") || e.message.includes("audio") || e.message.includes("initialization") ? new G(
      "オーディオシステムの初期化に失敗しました。デバイスの音響設定を確認するか、ブラウザを再起動してください。",
      {
        operation: t,
        originalError: e.message,
...
class ct {
  ...
  calculateOverallQuality(e, t, i, s) {
    ...
    return i !== null ? o += (1 - Math.min(i, 1)) * n.breathiness : o += 0.7 * n.breathiness, t.detected && t.regularity > 0.7 ? o += 0.9 * n.vibrato : t.detected ? o += 0.6 * n.vibrato : o += 0.5 * n.vibrato, o >= 0.85 ? j.EXCELLENT : o >= 0.7 ? j.GOOD : o >= 0.5 ? j.FAIR : j.POOR;
  }
  /**
...
class lt {
  ...
  calculateOptimalSettings(e, t, i) {
    const s = this.getDefaultSettings(), n = Math.max(0.5, Math.min(2, 1 - t.offset)), o = s.sensitivity * n, a = Object.keys(e).map((p) => parseInt(p)).filter((p) => p >= 100 && p <= 800).map((p) => e[p]), c = a.length > 0 ? a.reduce((p, w) => p + w, 0) / a.length : -60, h = Math.max(-20, c + 10), f = Math.max(s.noiseGate, Math.abs(h) / 1e3), u = Object.keys(i).map((p) => parseInt(p)).sort((p, w) => p - w).map((p) => i[p]), m = u.slice(0, Math.floor(u.length * 0.3)), g = u.slice(
      Math.floor(u.length * 0.3),
      Math.floor(u.length * 0.7)
    ), v = u.slice(Math.floor(u.length * 0.7)), y = m.reduce((p, w) => p + w, 0) / m.length, S = g.reduce((p, w) => p + w, 0) / g.length, A = v.reduce((p, w) => p + w, 0) / v.length;
    return {
...
const T = class T {
  ...
  static equalTemperamentToJustIntonation(e) {
    const t = e * 100, i = T.getJustIntonationRatios();
    let s, n = 1 / 0;
  ...
  static analyzeMelody(e) {
    ...
    for (let i = 1; i < e.length; i++) {
      const s = e[i - 1], n = e[i], o = x.frequencyToNote(s), r = x.frequencyToNote(n), a = x.getSignedInterval(s, n), c = x.getIntervalInfo(Math.abs(a)), h = a > 0 ? "up" : a < 0 ? "down" : "same";
      t.push({
        fromNote: o,
        toNote: r,
        interval: c,
  ...
  static generateChordProgression(e, t = "major", i = [1, 4, 5, 1]) {
    ...
    const n = T.generateScale(s, t === "minor" ? "naturalMinor" : "major"), o = [];
    return i.forEach((r) => {
      const a = n[(r - 1) % n.length], c = t === "major" ? T.getMajorScaleChordType(r) : T.getMinorScaleChordType(r), h = T.generateChord(a.frequency, c);
      o.push(h);
    }), o;
  }
  /**
...
let Fe = T;
const ht = "1.1.3", ut = (/* @__PURE__ */ new Date()).toISOString(), dt = {
  pitchDetector: {
    fftSize: 4096,
    smoothing: 0.1,
    clarityThreshold: 0.4,
...
export {
  rt as AudioDetectionComponent,
  Te as AudioManager,
  ut as BUILD_DATE,
  lt as CalibrationSystem,
  dt as DEFAULT_CONFIG,
  K as DeviceDetection,
  Ye as ErrorNotificationSystem,
  x as FrequencyUtils,
  at as HarmonicCorrection,
  ue as LogLevel,
  ce as Logger,
