...
- [Stack Overflow](https://stackoverflow.com/questions/77241929/audio-from-mic-in-safari-mac-unexpectedly-diminishes-in-volume-after-several-s)
...
- `IOS_SAFARI_GETUSERMEDIA_ISSUE.md` - 詳細ドキュメント

---

**作成日**: 2025年11月26日
**ステータス**: 調査完了・アプリ側対策を推奨
**関連バージョン**: v1.3.6時点での調査
